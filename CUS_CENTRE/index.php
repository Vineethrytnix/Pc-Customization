                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                        <a class="dropdown-item" href="view_delivery_boy.php">Delivery Boy</a>
                                        <a class="dropdown-item" href="view_orders.php">Orders</a>
                                        <a class="dropdown-item" href="view_products.php">Products</a>
                                        <a class="dropdown-item" href="view_requirements.php">Pc Requests</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                        <a class="dropdown-item" href="add_products.php">Products</a>
                                        <a class="dropdown-item" href="add_deliveryboy.php">Delivery Boy</a>
                    ...
                    <div class="banner_slider owl-carousel">
                        <div class="single_banner_slider">
                            ...
                            <div class="row">
                                ...
                                <div class="banner_img d-none d-lg-block">
                                    <img src="../img/banner_img.png" height="400px" alt="">
                                </div>
                            </div>
                        </div>
